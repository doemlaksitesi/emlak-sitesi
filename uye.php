...
<html lang="<? echo $Lang ?>">
    ...
    <head>
        ...
        <meta property="og:title"   content="<?= ($uye['fname']) ?> <?= ($uye['lname']) ?> <?= ($uye['firmaadi']) ?>" />
        <meta property="og:description" content="<?= ($uye['fname']) ?> <?= ($uye['lname']) ?> <?= ($uye['firmaadi']) ?>" />
        <meta property="og:image" content="<?= (SITEURL) ?>assets/uploads/Uyeler/<?= ($avatar) ?>" />
                        ...
                        <div class="agent">
                            <div class="row">
                                <div class="image span1">
                                    <img src="assets/uploads/Uyeler/<?= ($avatar) ?>" class="thumbnail-image" alt="<?= ($uye['firmaadi']) ?> - <?= ($uye['fname']) ?> <?= ($uye['lname']) ?>" >
                                </div><!-- /.image -->
                                <div class="span8">
                                    <div class="info">
                                        <div class="box">
                            ...
                            <div class=row-fluid>
                                ...
                                <div class="btn-group">
                                    ...
                                    while ($rsListx = mysql_fetch_array($queryList1)) {
                                        ...
                                        <a class="btn <?= ($secili) ?>" href="<?= ($SiteAddress) ?><?= (seflink($uye['firmaadi'])) ?>/uye-<?= ($uye['id']) ?>/?Cat=<? echo $rsListx['ItemID']; ?>">
                                ...
                                <div class="pull-right" >
                                    <label class="pull-left" style="padding-top: 3px;"><?= ($dil['arama-kriterleri']) ?> :</label>&nbsp;
